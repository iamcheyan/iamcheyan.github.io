...
<div id="footer">
    <div class="footer_wrap">
    	<div class="custom-txt">
        	<div class="notes_left"><?php echo stripslashes($misa_footer_left); ?></div>       
        	<div class="notes_right"><?php echo stripslashes($misa_footer_right); ?></div>  
        </div><!-- .custom-txt -->
        <div class="copyright">
        ...
        <a class="roll_top" href="#" title="<?php _e( 'Scroll to top', 'misa' ); ?>"></a> 
