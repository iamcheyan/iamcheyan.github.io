...
$meta_boxes = array(
				...
				"description" => __( 'Featured Image', 'misa' ) ),
				
				"featured_image" => array(
				"id" => "thumb",
				"title" => __( 'Featured Image URL:', 'misa' ),
				"type" => "text",
				"description" => __( 'Paste in the URL of a featured image associated with this post. You can upload an image to the media library and use its URL here.', 'misa') ),
				...
				"info3" => array( "type" => "heading",
								"description" => __( 'Slider options for this post', 'misa' ) ),				
				
				"hide_caption" => array(
								"id" => "hide_caption",
								"title" => __( 'Check to hide caption for this post on Slider', 'misa' ),
								"type" => "checkbox",
								"description" => __( 'If unchecked, post title will be used as caption.', 'misa' ) ),
				
				"caption" => array(
								"id" => "caption",
								"title" => __( 'Custom HTML Caption for this post', 'misa' ),
								"type" => "text",
								"description" => __( 'Write a custom caption for this post. This caption will be shown on slider.', 'misa' ) ),
				
				"img_link" => array(
								"id" => "img_link",
								"title" => __( 'Slider image links to', 'misa' ),
								"type" => "text",
								"description" => __( 'Enter a URL to which the slider image should link to. Example: http://somesite.com. If left empty, the image will link to the permanent post.', 'misa' ) ),
				
				"no_link" => array(
								"id" => "no_link",
								"title" => __( 'Do not link slide images', 'misa' ),
								"type" => "checkbox",
								"description" => __( 'Check to de-activate links for slide images.', 'misa' ) ),																													
								);
...
function create_meta_box() {
	...
	if( function_exists( 'add_meta_box' ) ) {
		add_meta_box( 'new-meta-boxes', __('Post Options','misa'), 'display_meta_box', 'post', 'normal', 'high' );
	}
}
