...
class Misa_Content_Slider extends WP_Widget {
	function Misa_Content_Slider() {
		$widget_ops = array( 'classname' => 'misa_content_slider', 'description' => __( 'Slide show of your custom HTML content. You can use it for testimonials, or image slide show.', 'misa') );
		$this->WP_Widget('misa-content-slider', __( 'Misa Content Slider', 'misa' ), $widget_ops);
	}
	...
	function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id('text'); ?>"><?php _e( 'Your HTML content wrapped in li tags:', 'misa' ); ?></label>
		...
		<small><?php _e( 'Wrap each entry for slideshow inside li tags.', 'misa' ); ?></small>
        </p>        
		<p><label for="<?php echo $this->get_field_id('sliderID'); ?>"><?php _e( 'Unique ID name for content slider:', 'misa' ); ?></label> 
        ...
        <p>
            ...
            <option value="scrollDown"<?php selected( $instance['fx'], 'scrollDown' ); ?>><?php _e('Scroll Down', 'misa'); ?></option>
            </select>
        </p><br/> 
