...
$fam1 = font_family($misa_heading_font);
$fam2 = font_family($misa_ft_heading_font);
$fam3 = font_family($misa_bl_heading_font);
$famx = $fam1;
...
<style type="text/css">
<?php if( $misa_custom_headings == 'true' ) { ?>
h1, h2, h3, h4, h5 { 
font-family:'<?php echo $misa_heading_font; ?>', sans-serif; 
color:#<?php echo $misa_heading_color; ?>; 
font-weight:<?php echo font_weight($misa_heading_font_style);?>;
font-style:<?php echo font_style($misa_heading_font_style);?>
}
.page_titles h1 { 
font-family:'<?php echo $misa_ft_heading_font; ?>', sans-serif; 
color:#<?php echo $misa_ft_heading_color; ?>; 
font-weight:<?php echo font_weight($misa_ft_heading_font_style);?>;
font-style:<?php echo font_style($misa_ft_heading_font_style);?>
 }
.entry h2 { 
font-family:'<?php echo $misa_bl_heading_font; ?>', sans-serif; 
font-style:<?php echo font_style($misa_bl_heading_font_style);?>; 
font-weight:<?php echo font_weight($misa_bl_heading_font_style);?>
}
.entry h2, .entry h2 a {
color:#<?php echo $misa_bl_col; ?>;
 }
.entry h2 a:hover { 
color:#<?php echo $misa_bl_hvr_col; ?>;
text-decoration:none
 }
.sidebar h5 {
font-family:'<?php echo $misa_sb_heading_font; ?>', sans-serif; 
font-style:<?php echo font_style($misa_sb_heading_font_style);?>; 
font-weight:<?php echo font_weight($misa_sb_heading_font_style);?>;
color:#<?php echo $misa_sb_heading_color; ?>;
} 
.secondary h5 {
font-family:'<?php echo $misa_sc_heading_font; ?>', sans-serif; 
font-style:<?php echo font_style($misa_sc_heading_font_style);?>; 
font-weight:<?php echo font_weight($misa_sc_heading_font_style);?>;
color:#<?php echo $misa_sc_heading_color; ?>;
} 	
<?php
}
echo( '.brand { padding:'.$misa_logo_mrgtop.'px 0px '.$misa_logo_mrgbtm.'px 30px }');
echo( '.cycle_wrapper, .cycle_slider, .cycle_slider li, .nivo_wrapper, #nivo_slider { height:'.$misa_sl_ht.'px }');
