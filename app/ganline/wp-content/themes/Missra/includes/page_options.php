...
$page_options = array(
				...
				"info1" => array( "type" => "heading",
								"description" => __( 'Sidebar', 'misa' ) ),
								
				"sidebar_opts" => array(
								"id" => "sidebar_opts",
								"title" => __( 'Sidebar Placement', 'misa' ),
								"std" => "right",
								"type" => "select",
								"options" => array("right", "left", "none"),	
								"description" => __( 'Choose right, left or none.', 'misa' ) ),
				
				// Exclusive widget areas			
				"info2" => array(
								"type" => "heading",
								"description" => __( 'Exclusive widget areas', 'misa' ) ),
								
				"unique_header_bar" => array(
								"id" => "unique_header_bar",
								"title" => __( 'Create an exclusive header widget area', 'misa' ),
								"type" => "checkbox",
								"description" => __( 'If unchecked, default header widget area will be used, as on blog pages.', 'misa' ) ),									
								
				"unique_feat_bar" => array(
								"id" => "unique_feat_bar",
								"title" => __( 'Create an exclusive featured widget area', 'misa' ),
								"type" => "checkbox",
								"description" => __( 'If unchecked, default featured widget area will be used, as on blog pages.', 'misa' ) ),													
				
				"unique_sidebar" => array(
								"id" => "unique_sidebar",
								"title" => __( 'Create an exclusive sidebar', 'misa' ),
								"type" => "checkbox",
								"description" => __( 'If unchecked, default sidebar will be used, as on blog pages.', 'misa' ) ),	
								
			"unique_secondarybar" => array(
								"id" => "unique_secondarybar",
								"title" => __( 'Create an exclusive secondary area', 'misa' ),
								"type" => "checkbox",
								"description" => __( 'If unchecked, default secondary area will be used, as on blog pages.', 'misa' ) ),	
								
				"hr1" => array(	"type" => "hr"),
				
				//Page Caption				
				"info3" => array( "type" => "heading",
								"description" => __( 'Page Caption', 'misa' ) ),																													
				
				"custom_caption" => array(
								"id" => "custom_caption",
								"title" => __( 'Custom page Caption', 'misa' ),
								"type" => "text",
								"description" => __( 'Enter a custom caption for this page.', 'misa' ) ),
								
				"hide_feat" => array(
								"id" => "hide_feat",
								"title" => __( 'Hide Featured Area', 'misa' ),
								"type" => "checkbox",
								"description" => __( 'Check to completely hide Featured Area section on this page.', 'misa' ) ),
				...
				"info4" => array(
								"type" => "heading",
								"description" => __( 'If using this page as Portfolio or Blog Template', 'misa' ) ),									
								
				"category" => array(
								"id" => "category",
								"title" => __( 'Category for Posts', 'misa' ),
								"type" => "text",
								"description" => __( 'Enter a category ID, or IDs separated by commas, from which you wish to show posts.', 'misa' ) ),
								
				"post_per_page" => array(
								"id" => "post_per_page",
								"title" => __( 'Posts per page', 'misa' ),
								"type" => "text",
								"description" => __( 'The number of posts to show per page.', 'misa' ) ),
								
			"titles" => array(
								"id" => "titles",
								"title" => __( 'Hide Portfolio Captions', 'misa' ),
								"type" => "checkbox",
								"description" => __( 'Check to hide portfolio captions, so that you can show a classic gallery.', 'misa' ) ),
								
				"info5" => array(
								"type" => "heading",
								"description" => __( 'Custom Header image or embed code', 'misa' ) ),									
								
				"cust_embed" => array(
								"id" => "cust_embed",
								"title" => __( 'Custom image or flash embed code:', 'misa' ),
								"type" => "textarea",
								"description" => __( 'Enter an HTML source code for image or Flash header here. Important: The page caption and featured widget area will be overridden by this image.', 'misa' ) ),																								
);

function create_page_options() {
	global $page_key;	
	if( function_exists( 'add_meta_box' ) ) {
		add_meta_box( 'page-banner-options',  __('Page Options','misa'), 'display_page_options', 'page', 'normal', 'high');
	}
}
