			...
			if( have_posts() ) :
				...
				<ul class="port2">
					...
					?>
						...
						<?php if ( $thumbnail ) { ?><a rel="prettyPhoto[image]" href="<?php echo $thumbnail; ?>"><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo $thumbnail; ?>&amp;w=280&amp;h=180&amp;zc=1&amp;q=100" alt="<?php the_title(); ?>"/></a><?php } ?> </div>
<?php if ( !$titles ) {
						?>
